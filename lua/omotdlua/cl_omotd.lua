  ...
  net.Receive("omotd_openmotd", function()
    ...
    surface.CreateFont("omotd_announcementfont", {
      ...
      frame.Paint = function(s, w, h)
        ...
        draw.SimpleText(OMOTD.Config.ServerName .. " - OMOTD", "omotd_buttonfont", w * 0.008, h * 0.005, Color(255, 255, 255), 0, 0)
      ...
      Home_Panel.Paint = function(s, w, h)
        ...
        draw.SimpleText("Server information:" , "omotd_welcomefont", w * 0.03, h * 0.3, Color(255, 255, 255), 0, 0)
        draw.SimpleText("Name: " .. GetHostName() , "omotd_buttonfont", w * 0.03, h * 0.4, Color(255, 255, 255), 0, 0)
        draw.SimpleText("Players: " .. #player.GetAll() ..  "/" .. game.MaxPlayers(), "omotd_buttonfont", w * 0.03, h * 0.44, Color(255, 255, 255), 0, 0)
        draw.SimpleText("Gamemode: " .. gmod.GetGamemode().Name, "omotd_buttonfont", w * 0.03, h * 0.48, Color(255, 255, 255), 0, 0)
        draw.SimpleText("Map: " .. game.GetMap(), "omotd_buttonfont", w * 0.03, h * 0.52, Color(255, 255, 255), 0, 0)

        local mult = 10^(0)
        local timeup = math.floor(CurTime() / 60 * mult + 0.5) / mult

        draw.SimpleText("Up time: " .. timeup .. " minutes", "omotd_buttonfont", w * 0.03, h * 0.56, Color(255, 255, 255), 0, 0)
      ...
      Home_Avatar:SetPlayer(LocalPlayer(), 128)
      ...
      for k,v in ipairs(OMOTD.Config.Servers) do
        ...
        JoinButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, anim, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Join", "omotd_timefont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      for k,v in ipairs(StaffTable) do
        ...
        ProfileButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, anim, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Steam Profile", "omotd_timefont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      HomeButton.Paint = function(s, w, h)
        ...
        draw.RoundedBox(0, 0, 0, Home_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
        draw.SimpleText("Home", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableRuleButton == true) then
        ...
        RuleButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Rule_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Rules", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableForumButton == true) then
        ...
        ForumButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Forum_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Forums", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableGroupButton == true) then
        ...
        GroupButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Group_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Steam Group", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableWorkshopButton == true) then
        ...
        WorkshopButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Workshop_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Workshop", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableDonateButton == true) then
        ...
        DonateButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Donate_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Donate", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableServersButton == true) then
        ...
        ServersButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Server_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Server Portal", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      if(OMOTD.Config.EnableStaffOnlineButton == true) then
        ...
        StaffButton.Paint = function(s, w, h)
          ...
          draw.RoundedBox(0, 0, 0, Staff_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
          draw.SimpleText("Staff Online", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
      ...
      CloseButton.Paint = function(s, w, h)
        ...
        draw.RoundedBox(0, 0, 0, Close_Lerp, h, Color(255, 255, 255, OMOTD.Config.AlphaForAnim))
        draw.SimpleText("Close", "omotd_buttonfont", w / 2, h / 2, Color(255, 255, 255), 1, 1)
